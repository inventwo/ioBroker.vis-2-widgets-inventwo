...
export default class InventwoWidgetRadialSlider extends InventwoGeneric {
    containerRef;
    constructor(props) {
        super(props);
        this.state = {
    ...
    renderWidgetBody(props) {
        ...
        const size = Math.min(parseInt(this.state.rxStyle.width) || 200, parseInt(this.state.rxStyle.height) || 200);
        ...
        return (_jsxs(Box, { ref: this.containerRef, sx: containerStyle, onMouseDown: this.handleMouseDown, onTouchStart: this.handleMouseDown, children: [_jsxs("svg", { width: size, height: size, style: { overflow: 'visible' }, children: [_jsx("path", { d: trackPath, fill: "none", stroke: trackStyle.trackColor, strokeWidth: trackStyle.trackWidth, strokeLinecap: "round", style: {
                            ...
                            } }), _jsx("path", { d: activePath, fill: "none", stroke: trackStyle.trackActiveColor, strokeWidth: trackStyle.trackWidth, strokeLinecap: "round" }), _jsx("circle", { cx: thumbPosition.x, cy: thumbPosition.y, r: thumbStyle.thumbSize / 2, fill: thumbStyle.thumbColor, style: {
