...
export default class InventwoWidgetCheckbox extends InventwoGeneric {
    ...
    renderWidgetBody(props) {
        ...
        return (_jsx(FormGroup, { children: _jsx(FormControlLabel, { sx: attributesLabel, control: _jsx(Checkbox, { sx: attributes, onClick: () => this.onChange(), checked: isChecked }), label: isChecked ? this.state.rxData.textTrue : this.state.rxData.textFalse, labelPlacement: this.state.rxData.textPosition }) }));
    }
}
