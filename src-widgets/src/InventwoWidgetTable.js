...
export default class InventwoWidgetTable extends InventwoGeneric {
    ...
    renderWidgetBody(props) {
        ...
        if (value === undefined || value === null || value === '') {
            return _jsx("div", { children: "Keine Daten" });
        }
        try {
            ...
            return _jsx("div", { children: "Invalides JSON" });
        }
        const headers = [];
        const rows = [];
        ...
        if (json && json.length > 0) {
            ...
            if (countColumns === 0) {
                Object.keys(json[0]).forEach((h, index) => {
                    headers.push(_jsx(StyledTableHeaderCell, { children: h }, index));
                });
            }
            else {
                for (let i = 1; i <= this.state.rxData.countColumns; i++) {
                    ...
                    headers.push(_jsx(StyledTableHeaderCell, { style: styles, children: columnTitle }, i));
                }
            }
            ...
            for (let index = 0; index < maxRows; index++) {
                ...
                if (countColumns === 0) {
                    Object.values(r).forEach((v, indexCol) => {
                        ...
                        columns.push(_jsx(StyledTableCell, { children: v }, `${index}_${indexCol}`));
                    });
                }
                else {
                    for (let i = 1; i <= this.state.rxData.countColumns; i++) {
                        ...
                        if ((columnValue === null || columnValue === '') && columnPlaceholder) {
                            ...
                            if (columnValue) {
                                ...
                                if (datetimeFormat === 'datetime') {
                                    ...
                                    columnValue = this.formatDate(columnValue, this.state.rxData[`columnDatetimeFormatCustom${i}`] ?? '');
                                }
                            }
                        }
                            ...
                            columnValue = (_jsx("img", { src: columnValue, style: {
                                    width: columnWidth,
                                }, alt: columnValue }));
                        }
                        else {
                        ...
                        columns.push(_jsxs(StyledTableCell, { style: {
                                textAlign: this.state.rxData[`columnContentAlign${i}`],
                            }, children: [columnPrefix, columnValue, columnSuffix] }, `${index}_${i}`));
                    }
                }
                rows.push(_jsx(StyledTableRow, { sx: { '&:last-child td, &:last-child th': { border: 0 } }, children: columns }, index));
            }
        }
        let shadow = '';
        ...
        return (_jsx("div", { style: {
            ...
            }, children: _jsx(TableContainer, { component: Paper, style: {
                    height: '100%',
                    background: 'transparent',
                    borderRadius: 0,
                }, children: _jsxs(Table, { children: [this.state.rxData.showHead && (_jsx(TableHead, { children: _jsx(StyledTableHeaderRow, { children: headers }) })), _jsx(TableBody, { children: rows })] }) }) }));
    }
}
