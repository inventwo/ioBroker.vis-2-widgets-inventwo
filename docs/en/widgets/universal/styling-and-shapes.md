...
- **Mirror** — Per-state mirror override: **Default (from content)** uses the global mirror setting from the content style group; **Yes** forces the content to be mirrored in this state; **No** forces it not to be mirrored.
